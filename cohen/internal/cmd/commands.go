...
var AllCommands = []string{"/help", "/sessions", "/new", "/clear", "/exit", "/rename", "/model", "/settings"}
...
func Parse(input string) Result {
	...
	case "/model", "/models":
		return Result{IsCommand: true, Action: ActionModel}
	case "/settings", "/setting":
		return Result{IsCommand: true, Action: ActionSettings}
	}
